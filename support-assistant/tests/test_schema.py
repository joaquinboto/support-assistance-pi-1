...
from schema import ErrorValidacionSchema, validar_respuesta
...
def test_campo_faltante_es_rechazado():
    with pytest.raises(ErrorValidacionSchema):
        validar_respuesta({"answer": "x", "confidence": 0.5, "category": "other", "actions": []})
